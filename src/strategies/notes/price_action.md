...
## Log
- 2026-08-07: Backtest "Run Again" no longer forces 5-min — the hidden resolution input carries the run's actual resolution; the per-pattern backtest's PA Candle dropdown gained the 15-min option so it can show the global value.
