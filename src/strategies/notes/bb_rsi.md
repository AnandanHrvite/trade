...
## Log
- 2026-08-11: light-theme button colours on the Backtest and Live pages. `.run-btn` was a dark navy fill the light skin's hex rewriter has no entry for, and Stop/Exit kept their dark maroon/brown next to a Start button that did map — all now paint as solid light-theme buttons with white labels (≥4.8:1). Styling only.
