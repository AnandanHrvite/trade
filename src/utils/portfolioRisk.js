...
const PAPER_MODES = ["ema_rsi_st", "bb_rsi", "pa", "orb", "ema9vwap", "trend_pb", "trend_day_scalp", "rsi_pivot_st", "bn_pivot_rsi_st", "ema_rsi_st_v2", "bn_ema_rsi_st_v2", "simple930", "ha_scalp", "early_bird"];
