...
const MODES = ["ema_rsi_st", "bb_rsi", "pa", "orb", "ema9vwap", "trend_pb", "gaps", "trend_day_scalp", "gap_fix_3m", "ha_scalp", "rsi_pivot_st", "simple930", "simple930-live"];
...
<script>
  ...
  var _filesPage  = { ema_rsi_st:1, bb_rsi:1, pa:1, orb:1, ema9vwap:1, trend_pb:1, gaps:1, trend_day_scalp:1, gap_fix_3m:1, ha_scalp:1, rsi_pivot_st:1, simple930:1, 'simple930-live':1 };
  var _skipsPage  = { ema_rsi_st:1, bb_rsi:1, pa:1, orb:1, ema9vwap:1, trend_pb:1, gaps:1, trend_day_scalp:1, gap_fix_3m:1, ha_scalp:1, rsi_pivot_st:1, simple930:1, 'simple930-live':1 };
  var _auditPage  = 1;
