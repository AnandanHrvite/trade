...
router.get("/start", async (req, res) => {
  ...
  try {
    installed = liveHarness.installHarness({
      ...
      liveLogKey: "trend-day-scalp-live",
    });
  } catch (err) {
...
button { background:#a855f7; color:#fff; border:0; padding:8px 18px; border-radius:6px; cursor:pointer; font-size:0.85rem; margin-right:8px; }
