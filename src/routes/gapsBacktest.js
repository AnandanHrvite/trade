...
function renderErrorPage(msg, from, to) {
  return `<!DOCTYPE html><html${_errLightAttr()}><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/>${faviconLink()}<title>GAPS Backtest Error</title>
...
:root[data-theme="light"] a{border-color:#e0e4ea;background:#ffffff;color:#0369a1;}
