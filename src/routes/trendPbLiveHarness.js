...
button { background:#be185d; color:#fff; border:0; padding:8px 18px; border-radius:6px; cursor:pointer; font-size:0.85rem; margin-right:8px; }
...
async function startSession() {
  ...
  try {
    const r = await secretFetch('/trend-pb-live/start');
...
async function stopSession() {
  ...
  try {
    const r = await secretFetch('/trend-pb-live/stop');
