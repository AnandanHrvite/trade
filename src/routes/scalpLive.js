...
<div class="top-bar">
  <div>
    ...
    <div class="top-bar-meta">${scalpStrategy.NAME} \u00b7 ${SCALP_RES}-min candles \u00b7 Exit: hard stop + trailing stop + PSAR flip \u00b7 ${state.running ? "Auto-refreshes 2s" : "Not refreshing"}</div>
  </div>
