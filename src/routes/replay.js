...
function drawReplayChart(el, cd) {
  ...
  const overlays = [
    ...
    ['ema9', isEma9Vwap ? '#e5e7eb' : '#a855f7'], ['ema20', '#fbbf24'], ['ema50', '#3b82f6'], ['ema21', '#f472b6'],
    ['orhLine', '#34d399'], ['orlLine', '#f87171'],
  ];
  const _ovLabel = { bbUpper: 'BB↑', bbMiddle: 'BB·', bbLower: 'BB↓', ema9: 'EMA9', ema20: 'EMA20', ema50: 'EMA50', ema21: 'EMA21 (exit)', orhLine: 'ORH', orlLine: 'ORL' };
