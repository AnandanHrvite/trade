...
const SETTINGS_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "UI_SHOW_CONSOLIDATION_REPORT", label: "Show Consolidation Report", type: "toggle", effect: EFFECT.INSTANT, desc: "Show the top-level 'Consolidation Report' menu in the sidebar — one printable, filterable consolidated report of every recorded paper + live trade (filter by book / strategy / week / month / date range, group by day-week-month-strategy, and export to PDF). Read-only.", default: "true" },
