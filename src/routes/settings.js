...
const SETTINGS_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "EMA9VWAP_REVERSAL_EXIT_ENABLED", label: "2-Candle Reversal Exit", type: "toggle", effect: EFFECT.INSTANT, desc: "ON by default — after entry, square off the instant a candle CLOSES hard against the position: a CE bails on a bearish candle (close<open) closing below BOTH previous 2 candles' lows; a PE on a bullish candle closing above both previous 2 highs. Evaluated on candle close, rolling reference. Turn off to hold purely to the signal/EOD exit.", default: "true" },
