...
const SETTINGS_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "SCALP_STOP_LOSS_PTS", label: "Stop Loss (pts)", type: "number", min: 0, max: 200, step: 5, effect: EFFECT.SESSION, desc: "Always-on catastrophic loss cap — exit the instant the trade moves this many spot points against entry, on any candle (default 20 ≈ ₹1300 at 65 qty). Clips the deep adverse excursions on failed fades, not the normal small scalps. Points-based. 0 = disabled.", default: "20" },
