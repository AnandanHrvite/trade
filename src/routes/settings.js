...
const SETTINGS_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "PA_ADX_DIRECTIONAL", label: "ADX Directional (+DI/-DI)", type: "toggle", effect: EFFECT.SESSION, desc: "Require +DI > -DI for CE and -DI > +DI for PE. Applied to REVERSAL patterns only (Engulf, Hammer, Shooting Star, Double Top/Bottom, Triangles). BOS and Inside Bar Breakout are exempt — the breakout is itself the directional signal.", default: "true" },
