...
const SETTINGS_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "ORB_SL_CANDLES", label: "Stop-Loss Candles (trailing)", type: "number", min: 1, max: 10, step: 1, effect: EFFECT.INSTANT, desc: "The ONLY stop: SL = swing of the last N closed candles (CE → lowest low, PE → highest high). Ratchets up (CE) / down (PE) on each candle close — same level is the initial SL and the trail. No premium SL, no profit target; 15:15 square-off is the only other exit. 2 = last 2 candles.", default: "2" },
