...
async function validateAndGetOptionSymbol(spot, side, mode, opts = {}) {
  ...
  //    OIWF (OI Wall Fade) and HA_SCALP trade slightly ITM (~delta 0.6): higher delta tracks
  ...
  if (!_hasOverride && (_itmMode === "ORB" || _itmMode === "TREND_PB" || _itmMode === "GAPS" || _itmMode === "TDS" || _itmMode === "GAP3M" || _itmMode === "OIWF" || _itmMode === "HA_SCALP")) {
