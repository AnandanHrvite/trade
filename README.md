...
- **⛔ 2026-08-11 — 329 trades over 2.5 years say ORB does not work. Do not trade it.** The full backtest `2024-01-01 → 2026-08-11` reports **329 trades, 20.7% win rate, net −₹1,78,963, profit factor 0.39, max drawdown −₹1,79,110, Sharpe −5.44**, and every year is negative on its own: 2024 −₹95,275 (n=148, PF 0.30), 2025 −₹51,420 (n=122, PF 0.52), 2026 Jan–Jul −₹32,268 (n=59, PF 0.38). This is well past the ~147 trades the sample-size note above asks for, so it is a verdict, not a small-sample wobble: **buying a slightly-ITM option on a 15-minute opening-range break has no edge on NIFTY.** 79% of trades lose ~₹1,130 each, and a 0-point scratch already costs ~₹420 in spread + theta.
