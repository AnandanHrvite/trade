...
| `EXPIRY_HEALTHCHECK_ENABLED` | `true` | Resolve the expiry on a schedule (08:00–15:30 IST, plus one run at 15:40) and at boot, so a bad week shows up before the open instead of as a skipped entry |
